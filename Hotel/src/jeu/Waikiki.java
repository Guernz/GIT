...
public class Waikiki extends Hotel{
	...
	public Waikiki(){
		...
		casePlateau[0]=Plateau.plateau.get(16);
		casePlateau[1]=Plateau.plateau.get(17);
		casePlateau[2]=Plateau.plateau.get(18);
		casePlateau[3]=Plateau.plateau.get(19);
		casePlateau[4]=Plateau.plateau.get(20);
	}
