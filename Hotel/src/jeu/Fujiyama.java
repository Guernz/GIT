...
public class Fujiyama extends Hotel{
	...
	public Fujiyama(){
		...
		casePlateau[0]=Plateau.plateau.get(1);
		casePlateau[1]=Plateau.plateau.get(2);
		casePlateau[2]=Plateau.plateau.get(3);
		casePlateau[3]=Plateau.plateau.get(4);
		casePlateau[4]=Plateau.plateau.get(5);
		casePlateau[5]=Plateau.plateau.get(6);
	}
