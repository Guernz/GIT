...
public class TajMahal extends Hotel{
	...
	public TajMahal(){
		...
		casePlateau[0]=Plateau.plateau.get(21);
		casePlateau[1]=Plateau.plateau.get(22);
		casePlateau[2]=Plateau.plateau.get(23);
		casePlateau[3]=Plateau.plateau.get(24);
		casePlateau[4]=Plateau.plateau.get(25);
	}
