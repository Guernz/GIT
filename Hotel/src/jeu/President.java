...
public class President extends Hotel{
	...
	public President(){
		...
		casePlateau[0]=Plateau.plateau.get(9);
		casePlateau[1]=Plateau.plateau.get(10);
		casePlateau[2]=Plateau.plateau.get(11);
		casePlateau[3]=Plateau.plateau.get(12);
		casePlateau[4]=Plateau.plateau.get(13);
		casePlateau[5]=Plateau.plateau.get(14);
		casePlateau[6]=Plateau.plateau.get(15);
	}
